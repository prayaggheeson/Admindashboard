...
const Accountsdetails = () => {
  ...
  return (
    <div className="w-full p-4 bg-white hover:shadow-xl hover:shadow-blue-900 rounded-lg">
      <div className="flex flex-col sm:flex-row justify-evenly items-center gap-4 mb-4 sm:mb-0">
        <h2 className="text-2xl sm:text-3xl px-6 py-2 text-center sm:text-start font-semibold">
          Username
        </h2>
        {walletAddress ? (
          <div className=" text-black  px-6 py-2 rounded-lg mr-4">
            Wallet Connected
          </div>
        ) : (
          <button
      ...
      <div className="flex flex-wrap">
        <div className="w-full sm:w-1/2 md:w-1/3">
          <div className="p-4 rounded-full justify-center hover:bg-blue-300">
            <h2 className="text-xl font-semibold">{walletAddress ? walletAddress.substring(0, 15) + "..." : "Not Connected"}</h2>
          </div>
        </div>
